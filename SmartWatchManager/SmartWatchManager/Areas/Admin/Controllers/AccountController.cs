...
namespace SmartWatchManager.Areas.Admin.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            accountManager.lstUser = db.Users.ToList();
            accountManager.lstCustomer = db.Customers.ToList();
        ...
        public ActionResult Edit([Bind(Include = "UserID,RoleID,FullName,Email,Password,Phone,Address,Image")] User user)
        {
